...
print('---ular piton----')
piton = ular('ular piton', 'karnivora', 'darat', 'bertelur', 'hijau dan kuning', 'tidak berbisa') 
piton.cetak_ular()

print('---ular Anaconda----')
Aanakonda = ular('ular Anakonda', 'karnivora', 'darat dan air', 'melahirkan', 'hijau dan hitam', 'tidak berbisa') 
Aanakonda.cetak_ular()